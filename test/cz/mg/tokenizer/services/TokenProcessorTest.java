...
public @Test class TokenProcessorTest {
    ...
    private void testProcessingNumbers() {
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.NUMBER, "69", 0)
            )
        );
        ...
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.NUMBER, "3.14", 0)
            )
        );
        ...
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.NUMBER, "3.14f", 0)
            )
        );
        ...
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.NUMBER, "0xA4", 0)
            )
        );
    ...
    private void testProcessingSingleQuotes() {
        ...
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.CHARACTER, "a .6", 0)
            )
        );
    ...
    private void testProcessingDoubleQuotes() {
        ...
        testProcessingSingleLine(
            ...
            new List<>(
                new Token(TokenType.STRING, "a .6", 0)
            )
        );
